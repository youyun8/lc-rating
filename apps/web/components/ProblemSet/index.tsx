...
function ProblemSet() {
  ...
  return (
    <div className="flex flex-col gap-5 px-4 py-6 md:px-8">
      {/* Header */}
      <div className="brand-glow motion-rise relative overflow-hidden rounded-3xl border border-border/60 bg-background/80 shadow-[0_30px_80px_-50px_rgba(6,182,212,0.55)]">
