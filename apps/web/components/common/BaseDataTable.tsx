...
export function BaseDataTable<TData>({
  ...
  headerBorderClassName = "border border-lime-200/80 bg-lime-50/80 dark:border-lime-900/60 dark:bg-lime-950/30",
  cellBorderClassName = "border border-lime-100/80 dark:border-lime-900/40",
  rowClassName,
  separator,
