...
const GithubBadge = () => {
  ...
  return (
    ...
    >
      <svg viewBox="0 0 438.549 438.549" className="h-4 w-4 sm:h-5 sm:w-5">
        <path
          fill="currentColor"
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        className="h-4 w-4 text-gray-300 transition ease-in group-hover:text-yellow-500 sm:h-5 sm:w-5"
      >
        <path
          fillRule="evenodd"
          fill="currentColor"
