    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="flex max-h-[90vh] flex-col gap-0 overflow-hidden p-0 sm:max-w-2xl">
        <DialogHeader className="border-b border-border/60 px-5 py-4">
          ...
          <DialogDescription>記錄解題思路、卡點或複習提醒。</DialogDescription>
        </DialogHeader>
        ...
        <div className="px-5 py-4">
          <textarea
            ...
            className="min-h-56 w-full resize-y rounded-md border border-input bg-background px-3 py-2 text-sm leading-6 shadow-xs outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50"
          />
        </div>
