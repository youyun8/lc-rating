...
const competitiveProgrammingCourseMaterials: Record<number, string> = {
  ...
  9: [
    ...
    "```cpp\nstruct BitMaskSet {\n    static bool contains(int mask, int index) {\n        return mask & (1 << index);\n    }\n\n    static int add(int mask, int index) {\n        return mask | (1 << index);\n    }\n\n    static int remove(int mask, int index) {\n        return mask & ~(1 << index);\n    }\n\n    static int toggle(int mask, int index) {\n        return mask ^ (1 << index);\n    }\n};\n```",
