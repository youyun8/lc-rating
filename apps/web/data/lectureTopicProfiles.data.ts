...
import type { LectureTopicProfile } from "./lectureTopicProfiles";

// Bulky topic data extracted from lectureTopicProfiles.ts to keep that
// module a slim, navigable index of lookup logic.

export const lectureTopicProfiles: LectureTopicProfile[] = [
  {
...
export const defaultLectureExamples: Record<string, StudyPlanData.Item> = {
  "binary-lower-bound": {
    id: "1898",
    title: "可移除字元的最大數目",
...
export const exampleLectureOverrides: NonNullable<
  LectureTopicProfile["examples"]
> = {
