...
Sum of Subarray Ranges (LC 2104) = (sum of subarray maxima) − (sum of subarray minima), each a domination sum. Maximum Subarray Min-Product (LC 1856) multiplies each element's min-span by a prefix-sum window. The asymmetric strict/non-strict comparison (\`>=\` on one side, \`>\` on the other) prevents double-counting equal values.`,
    },
    {
      id: "bitwise",
...
The same per-bit split powers Count Beautiful Subarrays via prefix XOR (LC 2588) and OR/AND-over-all-subarrays totals.`,
    },
    {
      id: "pairwise",
...
| 891 | [Sum of Subsequence Widths](https://leetcode.cn/problems/sum-of-subsequence-widths) | subsequence \`2^k\` |
...
| 2681 | [Power of Heroes](https://leetcode.cn/problems/power-of-heroes) | subsequence \`2^k\` |`,
    },
    {
      id: "pitfalls",
      title: "Pitfalls & tips",
