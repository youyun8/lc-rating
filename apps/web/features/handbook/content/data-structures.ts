...
Related: [Monotonic Stack vs Deque](/handbook/monotonic-stack-vs-deque), [Trees & Binary Trees](/handbook/trees), [Strings](/handbook/strings) (Trie), [Graph Algorithms](/handbook/graph) (DSU drives Kruskal & connectivity). Going further: [Range Queries & Offline Algorithms](/handbook/range-queries-offline) (coordinate compression, sweep line, Mo's algorithm, persistent structures).`,
    },
    {
      id: "prefix",
