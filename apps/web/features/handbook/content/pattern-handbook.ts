...
const TOPIC_DEFINITIONS: PatternTopicDefinition[] = [
  {
    ...
    invariant:
      "At every design step, the proposed algorithm must fit both the input size and the value/query dimensions; otherwise it is only a sketch, not a solution.",
    variants: [
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 1981,
        difficulty: "Medium",
        subPattern: "budget-driven binary search",
        why: "Forces an algorithm choice from n, value bounds, and query count instead of from topic tags.",
        order: 7,
        tier: "Core Practice",
      },
  ...
  },
  {
    ...
    invariant:
      "The optimized method must answer exactly the same subquestions as brute force; only the method for retrieving repeated facts changes.",
    variants: [
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 1909,
        difficulty: "Medium",
        subPattern: "prefix-state pruning",
        why: "Shows the exact repeated work that must become prefix, window, sorting, or contribution state.",
        order: 7,
        tier: "Core Practice",
      },
  ...
  },
  {
    ...
    invariant:
      "The state is always a faithful summary of exactly the candidates it claims to represent; no candidate is silently added, lost, or counted twice.",
    variants: [
      "Window always valid.",
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2855,
        difficulty: "Hard",
        subPattern: "window monotonic invariant",
        why: "Requires a maintained condition after every pointer, stack, or greedy update.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    invariant:
      "The predicate must accept exactly the candidates that have at least one completion; approximate checks break both search and construction.",
    variants: [
      "Binary search on answer.",
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 1973,
        difficulty: "Medium",
        subPattern: "time feasibility predicate",
        why: "Turns optimization into yes/no predicates and checks monotonicity carefully.",
        order: 7,
        tier: "Core Practice",
      },
  ...
  },
  {
    ...
    invariant:
      "Two partial histories with the same state must have the same set of possible future completions, up to the value already accumulated.",
    variants: [
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2604,
        difficulty: "Hard",
        subPattern: "bitmask shortest-path state",
        why: "Rewards encoding enough state and no irrelevant history.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    invariant:
      "Every represented event or pointer position must correspond to exactly one real boundary in the original problem.",
    variants: [
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2330,
        difficulty: "Hard",
        subPattern: "permutation boundary handling",
        why: "Stresses inclusive/exclusive endpoints, empty cases, duplicates, and sentinel choices.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    invariant:
      "Every skipped candidate is either dominated, represented by state, or impossible under a maintained invariant.",
    variants: [
      "Loop invariant.",
      "Exchange argument.",
      "Greedy stays ahead.",
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2507,
        difficulty: "Hard",
        subPattern: "connectivity proof by ordering",
        why: "Needs a correctness argument, not only an implementation trick.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2474,
        difficulty: "Hard",
        subPattern: "combinatorial enumeration",
        why: "Trains choosing the one object to enumerate so the rest can be maintained.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2443,
        difficulty: "Hard",
        subPattern: "pair-distance contribution",
        why: "Direct practice for counting how many answers each element, pair, or boundary contributes to.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 1759,
        difficulty: "Medium",
        subPattern: "right endpoint window",
        why: "Practices fixing the right endpoint and converting all valid starts into a contribution.",
        order: 7,
        tier: "Core Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2694,
        difficulty: "Hard",
        subPattern: "enumerate parity states",
        why: "Makes the middle/pivot object explicit and moves the expensive parts into side state.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 1754,
        difficulty: "Medium",
        subPattern: "prefix/suffix insertion gain",
        why: "Uses left and right precomputation to remove repeated scans around a cut.",
        order: 7,
        tier: "Core Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2525,
        difficulty: "Hard",
        subPattern: "answer-space feasibility",
        why: "Separates value-space search from a linear or greedy feasibility check.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    templateKeys: ["coordinate_compression_fenwick"],
    complexity: [
      "Most optimized versions target O(n), O(n log n), O((n + q) log n), or O(2^n * poly(n)) depending on the state size.",
      "The hidden cost is usually inside the feasibility check, transition loop, or data-structure operation.",
      "If a template nests a scan inside another scan, re-check whether that scan should be precomputed or maintained.",
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2052,
        difficulty: "Medium/Hard",
        subPattern: "swap choice exchange",
        why: "Needs a local choice whose replacement argument can be defended.",
        order: 7,
        tier: "Advanced Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 1958,
        difficulty: "Medium",
        subPattern: "lexicographic greedy repair",
        why: "Builds the answer position by position while proving the suffix remains feasible.",
        order: 7,
        tier: "Core Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 1704,
        difficulty: "Medium",
        subPattern: "heap frontier scheduling",
        why: "Uses a frontier that is never behind any alternative after the same number of steps.",
        order: 7,
        tier: "Core Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2451,
        difficulty: "Hard",
        subPattern: "threshold query preprocessing",
        why: "Sorts events and queries so updates happen once and query state is cheap.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2671,
        difficulty: "Hard",
        subPattern: "area sweep with search",
        why: "Represents interval or geometry changes as events over one ordered coordinate.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2694,
        difficulty: "Hard",
        subPattern: "bitmask combinatorial DP",
        why: "Uses bitmasks to make exponential state explicit and memoizable.",
        order: 7,
        tier: "Challenge Practice",
      },
  ...
  },
  {
    ...
    practice: [
      ...
      },
      {
        ...
        rating: 2209,
        difficulty: "Hard",
        subPattern: "stable window invariant",
        why: "Requires writing and maintaining the exact condition before every loop iteration.",
        order: 7,
        tier: "Advanced Practice",
      },
