...
export const q3Handbook = {
  ...
  children: [
    ...
    },
    {
      ...
      summary:
        "以下每個模式章節的「模式總覽」都會先給直覺、訊號、模板與完整題表；再依需要進入子主題講義補強特定 Labels。",
