...
/**
 * Loads and joins problems, contests, tags and solutions into the
 * flat row shape consumed by the problem table.
 */
export function useProblemSetData() {
  const {
    problemMap = {},
  ...
  return {
    tableData,
    isPending,
    problemCount: Object.keys(problemMap).length,
